...
// type: "cba" | "abc" = "abc" - второй параметр/аргумент функции типизирован с помощью тайпа, он должен быть либо строкой "abc", либо строкой "bca", "=abc" - означет, что по умолчанию он равен "abc"
